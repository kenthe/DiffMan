function [obj] = tscg(varargin)
% TSCG - Constructor for the 'CG' timestepper class.
% function [obj] = tscg(varargin)
...
if (nargin == 0),
  obj.dummy = [];
  obj       = class(obj,'tscg',timestepper);
...
if (nargin == 1) & isa(arg,'timestepper'),
  ...
  obj.dummy = [];
  obj       = class(obj,'tscg',timestepper); % Creates new object!
